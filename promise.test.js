...
describe("Requirements", () => {
  ...
  describe("The then method", () => {
    ...
    describe("If onFulfilled is a function:", () => {
      ...
      it("it must not be called before promise is fulfilled.", () => {});
      it("it must not be called more than once.", () => {});
    });
    describe("If onRejected is a function,", () => {
      it("it must be called after promise is rejected, with promise’s reason as its first argument.", () => {});
      it("it must not be called before promise is rejected.", () => {});
      it("it must not be called more than once.", () => {});
      it("onFulfilled or onRejected must not be called until the execution context stack contains only platform code. [3.1].", () => {});
      it("onFulfilled and onRejected must be called as functions (i.e. with no this value). [3.2]", () => {});
  ...
  // 3.	Implementations may allow promise2 === promise1, provided the implementation meets all requirements. Each implementation should document whether it can produce promise2 === promise1and under what conditions.
